...
def youtube_search(request, song_name=None, singer=None):
    ...
    for ln in item_data:
        ...
        url_1 = "https://www.googleapis.com/youtube/v3/search?key=" + YouTube_API_KEY + "&part=snippet&q=" + SINGER_NAME + moji + SONG_NAME_1 + "&type=videos"
        url_2 = "https://www.googleapis.com/youtube/v3/search?key=" + YouTube_API_KEY + "&part=snippet&q=" + SINGER_NAME + moji + SONG_NAME_2 + "&type=videos"
        url_3 = "https://www.googleapis.com/youtube/v3/search?key=" + YouTube_API_KEY + "&part=snippet&q=" + SINGER_NAME + moji + SONG_NAME_3 + "&type=videos"
